        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
          ...
          <div className="flex flex-col justify-center space-y-4 animate-in fade-in slide-in-from-left duration-700">
            ...
            <div className="flex flex-wrap gap-3 sm:flex-nowrap">
              <Link href="/auth/register" className="group flex-1 sm:flex-none">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-primary text-primary-foreground transition-all duration-300 hover:scale-105 hover:shadow-lg hover:bg-primary/90 group-hover:translate-x-1"
                >
                  Get Started
              ...
              <Link href="#features" className="group flex-1 sm:flex-none">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto transition-all duration-300 hover:scale-105 hover:shadow-md hover:bg-accent/50 hover:border-primary/30"
                >
                  Learn More
                </Button>
              </Link>
